...
from flask_app.models import bands_models
...
#  =========================return all the sightings====================
    all_bands = bands_models.Band.get_all()
    return render_template("dash.html", logged_in_user=logged_in_user, all_bands=all_bands)
